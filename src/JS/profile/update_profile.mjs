...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (update_profile_form) {
        ...
        update_profile_form.addEventListener("submit", async (event) => {
            ...
            console.log("Updated avatar:", updated_avatar);

            // Making API call here with access token
            try {
                const response = await fetch(`${API_BASE}${API_UPDATE_PROFILE}${userName}`, {
                    method: 'PUT',
                    headers: {
                    ...
                    body: JSON.stringify(updated_avatar),
                });
                        ...
                        <div class="row pb-5">
                            <div class="col">
                                ...
                                <div class="card mt-5 text-center profile_card" id="profile_card">
                                    <img class="card-img-top rounded-pill profile_photo" src="${updated_avatar.avatar_url}" alt="Updated avatar">
